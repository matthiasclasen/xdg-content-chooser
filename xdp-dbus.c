...
static const _ExtendedGDBusArgInfo * const _xdp_dbus_content_portal_method_info_open_IN_ARG_pointers[] =
{
  &_xdp_dbus_content_portal_method_info_open_IN_ARG_types,
  NULL
};

static const _ExtendedGDBusArgInfo _xdp_dbus_content_portal_method_info_open_OUT_ARG_handle =
{
  {
    -1,
    (gchar *) "handle",
...
static const _ExtendedGDBusArgInfo * const _xdp_dbus_content_portal_method_info_open_OUT_ARG_pointers[] =
{
  &_xdp_dbus_content_portal_method_info_open_OUT_ARG_handle,
  NULL
};
...
static const _ExtendedGDBusMethodInfo * const _xdp_dbus_content_portal_method_info_pointers[] =
{
  &_xdp_dbus_content_portal_method_info_open,
  NULL
};
 ...
 */
guint
xdp_dbus_content_portal_override_properties (GObjectClass *klass, guint property_id_begin)
{
...
static void
xdp_dbus_content_portal_proxy_get_property (GObject      *object,
  guint         prop_id,
  GValue       *value,
...
static void
xdp_dbus_content_portal_proxy_set_property (GObject      *object,
  guint         prop_id,
  const GValue *value,
  GParamSpec   *pspec G_GNUC_UNUSED)
{
...
static void
xdp_dbus_content_portal_proxy_iface_init (XdpDbusContentPortalIface *iface)
{
}
...
static void
xdp_dbus_content_portal_skeleton_dbus_interface_flush (GDBusInterfaceSkeleton *_skeleton)
{
}
...
static void
xdp_dbus_content_portal_skeleton_iface_init (XdpDbusContentPortalIface *iface)
{
}
